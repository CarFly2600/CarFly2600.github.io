...
function filterCategory(filterBy, buttonClicked){
  ...
  /*The background colour will change depending on what manufacture filter the user choses. Colours were taken from the logos of Airbus, Boeing, Embraer, ATR, Bombardier and Comac respectively. */ 
  if (filterBy === 'A'){
    console.log(filterBy)
    document.body.style.backgroundColor = "var(--col-01)"; 
  }

  if (filterBy === 'B'){
    console.log(filterBy)
    document.body.style.backgroundColor = "var(--col-02)"; 
  }

  if (filterBy === 'EMB'){
    console.log(filterBy)
    document.body.style.backgroundColor = "var(--col-03)"; 
  }

  if (filterBy === 'ATR'){
    console.log(filterBy)
    document.body.style.backgroundColor = "var(--col-04)"; 
  }

  if (filterBy === 'BMD'){
    console.log(filterBy)
    document.body.style.backgroundColor = "var(--col-05)"; 
  }

  if (filterBy === 'CMC'){
    console.log(filterBy)
    document.body.style.backgroundColor = "var(--col-06)"; 
  }
  ...
  let itemsToFilter = Array.from(document.getElementsByClassName("PlaneBox"));
